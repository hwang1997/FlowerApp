    ...
    function showNotice() {
        layer.open({
            ...
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;">' +
                '<p class="">欢迎使用花店后台管理系统，在使用前请务必仔细阅读系统使用说明书，避免使用中遇到一些简单的问题造成困扰。</p>' +
                '<p style="margin-top: 10px">系统名称：<span>花店后台管理系统</span></p>' +
                '<p>当前版本：<span>v1.0</span></p>' +
                '<p>更新日期：<span>2020年3月20日</span></p>' +
                '<p>系统框架：<span>Spring Boot + MySql + Layui</span></p>' +
                '<p>开发工具：<span>IDEA + WebStorm</span></p>' +
                '<p>Layui：<span>https://www.layui.com/</span></p>' +
                '<p>LayuiCMS：<span>http://layuicms.com/</span></p></div>',
